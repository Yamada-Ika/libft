...
ft_itoa.c         ft_lstsize.c      ft_putstr.c       ft_strlen_s.c     ft_uitoa_base.c	\
ft_itoa_base.c    ft_memchr.c       ft_putstr_fd.c    ft_strmapi.c      ft_ultoa.c		\
ft_lltoa.c        ft_memcmp.c       ft_putuinbr.c     ft_strncmp.c      ft_ultoa_base.c
OBJS := $(SRCS:.c=.o)
